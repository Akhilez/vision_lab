"""
Slightly modified version of https://github.com/eborboihuc/rotate_3d
"""
...
def rotate_y(image, degrees):
    it = ImageTransformer(image)
    rotated = it.rotate_along_axis(phi=degrees)
    return rotated
...
if __name__ == '__main__':
    ...
    it = ImageTransformer(image)
    rotated = it.rotate_along_axis(phi=30)
